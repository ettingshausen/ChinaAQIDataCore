...
{
    public class WcfBinaryConverter
    {
        public static XmlDictionary WCFBinaryDictionary;

        static WcfBinaryConverter()
        {
            WCFBinaryDictionary = CreateWCFBinaryDictionary();
        }

        public static XmlDocument ConvertWcfBinaryMessageToXml(byte[] encodedMessage)
        {
        ...
        private static XmlDictionary CreateWCFBinaryDictionary()
        {
